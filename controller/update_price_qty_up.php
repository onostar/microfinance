<?php
        ...
        $prev_qty = htmlspecialchars(stripslashes($_POST['prev_qty']));
        ...
        // if($update){
            //update inventory
            $current_qty = $inv_qty + $prev_qty;
            $new_qty = $current_qty - $qty;
            $update_inv = new Update_table();
            $update_inv->update2cond('inventory', 'quantity', 'item', 'store', $new_qty, $item_id, $store);
        }
?>
