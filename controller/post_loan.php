<?php
    ...
    $get_exp = new selects();
    $exps = $get_exp->fetch_details_cond('ledgers', 'ledger_id', $loan);
    foreach($exps as $exp){
        $dr_ledger = $exp->acn;
    ...
    //post loan
    $add_data = new add_data('loans', $data);
    $add_data->create_data();
    if($add_data){
        //insert into transaction table
        if($trans_type == "receiving"){
            $credit_data = array(
                'account' => $dr_ledger,
        ...
        echo "<p>Loan Transaction Posted successfully!</p>";
    }
