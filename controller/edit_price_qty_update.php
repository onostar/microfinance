        ...
        <h3 style="background:var(--tertiaryColor);">Edit quantity and price for <?php echo strtoupper($name)?></h3>
            <div class="inputs">
                ...
                <div class="data" style="width:20%">
                    ...
                    <input type="hidden" name="prev_qty" id="prev_qty" value="<?php echo $row->quantity?>">
                ...
                <div class="data" style="width:20%">
                    <button type="submit" id="change_price" name="change_price" onclick="updatePriceQtyUp()">Update </button>
