        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center; color:red;font-size:.9rem">
                    ...
                    <a style="color:#fff; background:green;border-radius:4px;padding:5px 6px;" href="javascript:void(0)" title="increase quantity" onclick="increaseQtyWholesale('<?php echo $detail->sales_id?>', '<?php echo $detail->item?>')"><i class="fas fa-arrow-up"></i></a>
                    <a style="color:#fff; background:var(--primaryColor);border-radius:4px;padding:5px 6px;" href="javascript:void(0)" title="decrease quantity" onclick="reduceQtyWholesale('<?php echo $detail->sales_id?>')"><i class="fas fa-arrow-down"></i></a>
                    <a style="color:#fff; background:var(--otherColor);border-radius:4px;padding:5px 6px;" href="javascript:void(0)" title="show more options" onclick="showMoreWholesale('<?php echo $detail->sales_id?>')"><i class="fas fa-pen"></i></a>
            ...
            <div class="inputs" style="display:flex;flex-wrap:wrap">
                ...
                <div class="inputs" id="multiples">-->
                    <!-- <div class="data">
                        ...
                        <input type="datetime-local" name="post_date" id="post_date" value="<?php echo date("Y-m-d H:i:s")?>">
                    </div> -->
                    <!--<div class="data">
                        <label for="">POS</label>
