...
<div class="notify"><p><span><?php echo $name?></span> Removed from Issued items</p></div>
    ...
    <table id="stock_items_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a style="color:red; font-size:1rem" href="javascript:void(0) "title="delete purchase" onclick="deleteIssued('<?php echo $detail->issue_id?>', <?php echo $detail->item?>)"><i class="fas fa-trash"></i></a>
                </td>
