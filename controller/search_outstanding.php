<?php
    ...
    $details = $get_revenue->fetch_details_date('outstanding', 'date(post_date)', $from, $to);
    $n = 1;
?>
<h2>Outstanding debt postings  between '<?php echo date("jS M, Y", strtotime($from)) . "' and '" . date("jS M, Y", strtotime($to))?>'</h2>
    <hr>
    <div class="search">
...
<?php
    ...
    $amounts = $get_total->fetch_sum_2date('outstanding', 'amount', 'date(post_date)', $from, $to);
