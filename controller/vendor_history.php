<?php
    ...
    $details = $get_purchase->fetch_details_2date2Con('purchases', 'date(purchase_date)', $from, $to, 'vendor', $vendor, 'store', $store);
    $n = 1;  
?>
<div class="search">
...
?>
            <tr>
                ...
                <td style="color:var(--otherColor)"><?php echo date("jS M, Y", strtotime($detail->purchase_date));?></td>
