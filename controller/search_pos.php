<?php
    ...
    $details = $get_revenue->fetch_details_2date2Con('deposits', 'date(post_date)', $from, $to, 'payment_mode', 'Pos', 'store', $store);
    $n = 1;  
?>
...
<?php
    ...
    $amounts = $get_total->fetch_sum_2date2Cond('deposits', 'amount', 'date(post_date)', 'store', 'payment_mode', $from, $to, $store, 'Pos');
