...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2025 at 03:35 AM
...
INSERT INTO `document_uploads` (`document_id`, `customer`, `loan`, `doc_type`, `title`, `document`, `uploaded_by`, `upload_date`) VALUES
(1, 38, 14, 'BANK STATEMENT', 'Bank Statement For 6 Months', '50864_38.pdf', 8, '2025-07-02 14:01:42'),
(2, 38, 14, 'UTILITY BILL', 'Nepa Bill', '21272_38.docx', 8, '2025-07-02 14:10:04'),
(3, 38, 14, 'EMPLOYMENT LETTER', 'Employment Letter', '44601_38.png', 8, '2025-07-02 14:10:40');
...
INSERT INTO `guarantors` (`guarantor_id`, `client`, `loan`, `full_name`, `gender`, `phone_number`, `email_address`, `address`, `occupation`, `business`, `business_address`, `relationship`, `posted_by`, `post_date`) VALUES
(1, 38, 14, 'GODWIN OGUAMHENLU', 'Male', '08035716496', 'winner@mail.com', '27 Father Healey Street, Warri', 'Business Person', 'winner laundry', '1 emebiren street, warri', 'PARENT', 8, '2025-07-03 01:05:15'),
(2, 38, 14, 'ONOSTAR MEDIA', 'Male', '07068897068', 'onostarmedia@gmail.com', '1 Ogidan Street, Lagos', 'Business Person', 'onostar media solutions', '1 ogidan street', 'BUSINESS PARTNER', 8, '2025-07-03 01:09:04');
...
--
-- Dumping data for table `info_request`
--

INSERT INTO `info_request` (`request_id`, `customer`, `loan`, `request_text`, `request_status`, `requested_by`, `request_date`) VALUES
(2, 38, 14, 'Please Upload Your Last 6 Months Income Statement.\nAlso Please Upload Two Guarantors', 0, 1, '2025-07-02 12:22:49'),
(3, 38, 14, 'You Have To Upload Your Guarantor Info', 0, 1, '2025-07-02 15:38:59');
...
(14, 38, 3, 200000, 'House Rent', 'Monthly', 70000, 4, 8, 1, 2, 210, 3, '', 8, '2025-07-01 12:49:21', 0, 1, '2025-07-01 13:37:14', NULL, NULL);
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
