...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2025 at 01:49 PM
...
(1, 17, 38, 200000, 'TR252050725124854', '2025-07-05', 1, 1, '2025-07-05 12:48:54');
...
(17, 38, 3, 200000.00, 'School Fees', 'Monthly', 70000.00, 4, 8000.00, 1, 2000.00, 210000.00, 3, '', 8, '2025-07-04 14:04:52', 1, 1, '2025-07-04 14:05:26', NULL, NULL);
...
(162, 12, 'Upload Documents', 'upload_documents', 0),
(163, 12, 'Guarantors', 'guarantors', 0),
...
--
ALTER TABLE `cash_flows`
  MODIFY `flow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `ledgers`
  MODIFY `ledger_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
