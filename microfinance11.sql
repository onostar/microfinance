...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2025 at 06:45 PM
...
INSERT INTO `loan_applications` (`loan_id`, `customer`, `product`, `amount`, `purpose`, `frequency`, `installment`, `interest_rate`, `interest`, `processing_rate`, `processing_fee`, `total_payable`, `penalty`, `loan_term`, `collateral`, `posted_by`, `application_date`, `loan_status`, `approved_by`, `approve_date`, `disbursed_date`, `due_date`) VALUES
(31, 38, 3, 200000.00, 'Salary Advance', 'Monthly', 70000.00, 4, 8000.00, 1, 2000.00, 210000.00, 0, 3, '', 8, '2025-07-08 21:34:17', 3, 1, '2025-07-08 22:02:21', '2025-07-08 22:54:17', '2025-10-08 00:00:00'),
(32, 38, 1, 70000.00, 'Business', 'Weekly', 6066.67, 3, 2100.00, 1, 700.00, 72800.00, 0, 3, 'my shop', 8, '2025-07-09 10:05:08', 3, 1, '2025-07-09 10:06:33', '2025-07-09 10:06:57', '2025-10-01 00:00:00'),
(33, 38, 3, 250000.00, 'Business', 'Monthly', 87500.00, 4, 10000.00, 1, 2500.00, 262500.00, 0, 3, '', 1, '2025-07-10 08:11:14', 3, 1, '2025-07-10 08:11:29', '2025-07-10 08:11:56', '2025-10-10 00:00:00'),
(34, 44, 3, 300000.00, 'Business', 'Monthly', 105000.00, 4, 12000.00, 1, 3000.00, 315000.00, 0, 3, '', 1, '2025-07-10 08:33:29', 2, 1, '2025-07-10 08:34:53', '2025-07-10 08:37:29', '2025-10-10 00:00:00'),
(35, 38, 3, 100000.00, 'Business', 'Monthly', 35000.00, 4, 4000.00, 1, 1000.00, 105000.00, 0, 3, '', 8, '2025-07-11 12:42:33', -1, 0, NULL, NULL, NULL),
(36, 38, 1, 200000.00, 'Business', 'Weekly', 17333.33, 3, 6000.00, 1, 2000.00, 208000.00, 0, 3, 'non', 8, '2025-07-11 13:03:36', -1, 1, '2025-07-11 13:05:02', NULL, NULL),
(37, 38, 4, 700000.00, 'Business', 'Weekly', 62416.67, 5, 35000.00, 2, 14000.00, 749000.00, 0, 3, '', 8, '2025-07-11 14:15:42', 2, 15, '2025-07-11 14:16:01', '2025-07-11 14:16:45', '2025-10-03 00:00:00');
...
(20, '33', 'gain', 2285.71, 'Interest from Loan Repayment', 'TR488110725071655', '2025-07-11 07:16:55', 15),
(21, '33', 'gain', 571.43, 'Fees from Loan Repayment', 'TR488110725071655', '2025-07-11 07:16:55', 15),
(22, '34', 'gain', 457.14, 'Interest from Loan Repayment', 'TR054110725071816', '2025-07-11 07:18:16', 15),
(23, '34', 'gain', 114.29, 'Fees from Loan Repayment', 'TR054110725071816', '2025-07-11 07:18:16', 15),
(24, '33', 'gain', 1333.33, 'Interest from Loan Repayment', 'TR919110725072623', '2025-07-11 07:26:23', 1),
(25, '33', 'gain', 333.33, 'Fees from Loan Repayment', 'TR919110725072623', '2025-07-11 07:26:23', 1),
(26, '33', 'gain', 3047.62, 'Interest from Loan Repayment', 'TR212110725073938', '2025-07-11 07:39:38', 15),
(27, '33', 'gain', 761.90, 'Fees from Loan Repayment', 'TR212110725073938', '2025-07-11 07:39:38', 15),
(28, '33', 'gain', 3333.33, 'Interest from Loan Repayment', 'TR038110725123758', '2025-07-11 12:37:58', 1),
(29, '33', 'gain', 833.33, 'Fees from Loan Repayment', 'TR038110725123758', '2025-07-11 12:37:58', 1);
...
(94, 34, 44, 105000.00, 12000.00, 0.00, 1, '2025-08-10', 0, '2025-07-10 08:37:29', 1),
(95, 34, 44, 105000.00, 0.00, 0.00, 1, '2025-09-10', 0, '2025-07-10 08:37:29', 1),
(96, 34, 44, 105000.00, 0.00, 0.00, 1, '2025-10-10', 0, '2025-07-10 08:37:29', 1),
(97, 37, 38, 62416.67, 0.00, 0.00, 1, '2025-07-18', 0, '2025-07-11 14:16:45', 1),
(98, 37, 38, 62416.67, 0.00, 0.00, 1, '2025-07-25', 0, '2025-07-11 14:16:45', 1),
(99, 37, 38, 62416.67, 0.00, 0.00, 1, '2025-08-01', 0, '2025-07-11 14:16:45', 1),
...
--
ALTER TABLE `cash_flows`
  MODIFY `flow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
...
--
ALTER TABLE `deposits`
  MODIFY `deposit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `disbursal`
  MODIFY `disbursal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `kyc`
  MODIFY `kyc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `loan_applications`
  MODIFY `loan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `repayment_schedule`
  MODIFY `repayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;

--
-- AUTO_INCREMENT for table `transactions`
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1554;
