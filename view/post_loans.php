...
<div class="info" style="width:70%; margin:5px 0;"></div>
    ...
    <div class="add_user_form" style="width:70%; margin:5px 0;">
        <h3 style="background:var(--moreColor); text-align:left">Post Loans/mortgages</h3>
            ...
            <div class="inputs" style="gap:.7rem; align-items:flex-end">
                ...
                <div class="data" style="width:30%;">
                    ...
                    <select name="trans_type" id="trans_type">
                        ...
                        <option value="receiving">BORROWING</option>
                ...
                <div class="data" style="width:30%;">
                    <label for="financier"><span class='ledger'>Lender </span> (Financial Institution)</label>
                    <select name="financier" id="financier">
                        <option value="" selected>Select financier</option>
                        <?php
                            $get_heads = new selects();
                            $heads = $get_heads->fetch_details_cond('ledgers', 'class', 1);
                ...
                <div class="data" style="width:30%;">
                    <label for="loan"><span class="ledger">Loan Account</span></label>
                    <select name="loan" id="loan">
                        <option value="" selected>Select Loan Account</option>
                        <?php
                            $get_heads = new selects();
                            $heads = $get_heads->fetch_details_eitherCon('ledgers', 'ledger_id', 70, 71);
                            foreach($heads as $head){
                        ?>
                        <option value="<?php echo $head->ledger_id?>"><?php echo $head->ledger?></option>
                        <?php }?>
                ...
                <div class="data" style="width:30%; margin:5px 0">
                    <button type="submit" id="post_exp" name="post_exp" onclick="postLoan()">Post Transaction <i class="fas fa-save"></i></button>
                </div>
            </div>
        </section>    
    </div>
