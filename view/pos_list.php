...
<div id="revenueReport" class="displays management" style="width:100%!important">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_pos.php')">Search <i class="fas fa-search"></i></button>
</section>
    </div>
<div class="displays allResults new_data" id="revenue_report">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_date2Cond('deposits', 'date(post_date)', 'payment_mode', 'Pos', 'store', $store);
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_curdate2Con('deposits', 'amount', 'date(post_date)', 'payment_mode', 'POS', 'store', $store);
