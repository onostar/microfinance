    ...
    <div class="add_user_form" style="width:30%; margin:0">
        ...
        <section class="addUserForm">
            <div class="inputs" style="gap:1rem">
                ...
                <div class="data" style="width:100%">
                    <label for="class">Account Ledger</label>
                    <input type="text" name="ledger" id="ledger">
                </div>
                
            </div>
            <div class="inputs">
                <button type="submit" id="add_cat" name="add_cat" onclick="addLedger()">Save record <i class="fas fa-layer-group"></i></button>
            </div>
                            </section>    
    </div>
</div>
