...
?>
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_other_postings.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
<div class="displays allResults new_data" id="bar_items">
    <h2>Finance Costs Transactions</h2>
    <hr>
    <div class="search">
    ...
    <table id="item_list_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_items->fetch_details_cond('finance_cost', 'store', $store);
    ...
    <div class="all_modes">
        <?php
            ...
            $cashs = $get_cash->fetch_sum_curdateCon('finance_cost', 'amount', 'date(post_date)', 'store', $store);
