...
<div id="production_report" class="displays management" style="width:100%!important;">
    <div class="select_date">
        ...
        <section>    
            ...
            <button type="submit" name="search_date" id="search_date" onclick="search('search_production_report.php')">Search <i class="fas fa-search"></i></button>
        </section>
    </div>
    <div class="displays allResults new_data" id="revenue_report">
        <h2>Todays's Production from <?php echo $store_name?></h2>
        <hr>
        <div class="search">
        ...
        <table id="data_table" class="searchTable">
            ...
            <tbody>
                <?php
                    ...
                    $details = $get_users->fetch_details_curdateGro2con('production', 'date(post_date)', 'store', $store, 'product_status', 1, 'product_number');
                ...
                <tr>
                    ...
                    <td style="text-align:center"><?php echo $detail->product_qty?></td>
        ...
        <?php
            ...
            $prds = $get_prds->fetch_sum_2colCurDate1Con('production', 'raw_quantity', 'unit_cost', 'date(post_date)', 'store', $store);
