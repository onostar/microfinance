        ...
        <!-- <div class="info"></div> -->
            <div class="displays allResults" id="payment_det">
                ...
                <div class="payment_details">
                    ...
                    <tbody>
                        <?php
                            ...
                            $details = $get_transactions->fetch_details_2condGroup('invoices', 'customer', 'invoice_status', $customer, 1, 'invoice');
                            $n = 1;
                ...
                <?php
                    ...
                    if($balance < 0){
                        echo "<p class='total_amount' style='color:red; font-size:1rem;'>Total Due: ₦".number_format($balance * -1, 2)."</p>";
                    }
                ?>
                </div>
