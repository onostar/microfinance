...
<div class="info" style="width:70%; margin:5px 0;"></div>
    ...
    <div class="add_user_form" style="width:70%; margin:5px 0;">
        <h3 style="background:var(--primaryColor); text-align:left">Post Inventories and Cost of sales/service</h3>
            ...
            <div class="inputs" style="gap:.7rem; align-items:flex-end">
                ...
                <!-- <div class="data" style="width:30%;">
                    ...
                    <select name="trans_type" id="trans_type">
                        ...
                        <option value="Loan Fee">LOAN FEES</option>
                ...
                <!-- <div class="data" style="width:40%;">
                    <label for="financier"><span class='ledger'>Dr. Ledger</span> (Financier)</label>
                    <select name="financier" id="financier">
                        <option value="" selected>Select ledger</option>
                        <?php
                            $get_heads = new selects();
                            $heads = $get_heads->fetch_details_eitherCon2('ledgers', 'sub_group', 1, 'account_group', 2);
                ...
                <div class="data" style="width:30%; margin:5px 0">
                    <button type="submit" id="post_exp" name="post_exp" onclick="postInventories()">Post Transaction <i class="fas fa-save"></i></button>
                </div>
            </div>
        </section>    
    </div>
