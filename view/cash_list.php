...
<div class="displays allResults new_data" id="revenue_report">
    <h2>Cash Payments for today</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchCheckout" placeholder="Enter keyword" onkeyup="searchData(this.value)">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Cash Payment report')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_date2Cond('deposits', 'date(post_date)', 'payment_mode', 'Cash', 'store', $store);
    ...
    <?php
        ...
        $amounts = $get_total->fetch_sum_curdate2Con('deposits', 'amount', 'date(post_date)', 'payment_mode', 'Cash', 'store', $store);
