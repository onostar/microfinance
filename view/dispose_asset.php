    ...
    <table id="item_list_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_items->fetch_details_cond('assets', 'asset_status', 2);
            ...
            <tr>
                ...
                <td class="prices">
                    <a style="background:red!important; color:#fff!important; padding:5px 8px; border-radius:15px;" href="javascript:void(0)"class="each_prices" onclick="getForm('<?php echo $detail->asset_id?>', 'dispose_asset_form.php');"><i class="fas fa-trash"></i></a>
                </td>
