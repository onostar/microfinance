...
<div class="displays allResults">
    ...
    <h2>Loan Applications Pending Disbursement</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchRoom" placeholder="Enter keyword" onkeyup="searchItems(this.value, 'search_patients.php')">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('item_list_table', 'Pending Loan Disbursement')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
    <table id="item_list_table" class="searchTable">
        ...
        <?php
                ...
                $details = $get_items->fetch_details_condOrder('loan_applications', 'loan_status', 1, 'application_date');
