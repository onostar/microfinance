...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2025 at 02:29 PM
...
(30, '37', 'gain', 2336.45, 'Interest from Loan Repayment', 'TR061140725094852', '2025-07-14 09:48:52', 1),
(31, '37', 'gain', 934.58, 'Fees from Loan Repayment', 'TR061140725094852', '2025-07-14 09:48:52', 1),
(32, '34', 'gain', 3809.52, 'Interest from Loan Repayment', 'TR661150725071531', '2025-07-15 07:15:31', 15),
(33, '34', 'gain', 952.38, 'Fees from Loan Repayment', 'TR661150725071531', '2025-07-15 07:15:31', 15);
...
(97, 37, 38, 62416.67, 50000.00, 0.00, 1, '2025-07-18', 0, '2025-07-11 14:16:45', 1),
...
(109, 38, 45, 13000.00, 0.00, 0.00, 1, '2025-07-23', 0, '2025-07-16 12:26:58', 1),
...
--
ALTER TABLE `cash_flows`
  MODIFY `flow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
...
--
ALTER TABLE `deposits`
  MODIFY `deposit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `other_income`
  MODIFY `income_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1564;
